...
class PaisFormatterType extends FormatterBase {
  ...
  protected function viewValue(FieldItemInterface $item) {
    ...
    //CREAMOS UN AREGLO DE PAISES
    $paises = \Drupal::service('country_manager')->getList();

    //CUANDO LLAMO UN ARREGLOLE DOY COMO EL ID O LA LLAVE QUE NECESITA PARA EL DATO DEL ARREGLO
    $pais=$paises[$item->value];

    //El $item -> value, trae la abreviatura del pais
    return $pais;
    //FIN
  }
